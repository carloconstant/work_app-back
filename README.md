...
-user can record their info
  *opitional* weight and height
  *opitional* BMI calculator, fat ratio, calorie counter
-user can record sets, and rep range
  *opitional* users can track their progress with a graph and or listed history
.
...
1. Replace all instances of `workout_django` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `workout_django` which should be renamed
...
all instances of `workout_django` with your app's name.
